...
<html>
    <head>
        <meta charset="utf-8">
        <title>Exito!</title>
        <meta http-equiv="refresh" content="4;url=http://localhost:9090/SistemaAgil_IS2_war/DesarrolloController?accion=Redirect Relacion Proyecto_Backlog">
        <script>
    ...
    <body>
        <h1>Relacion concretada exitosamente!</h1>
         ...
         <form action="DesarrolloController" method="GET">
            <input type="submit" name="accion" value="Redirect Relacion Proyecto_Backlog"><br>
        </form>
    </body>
</html>
