...
<html>
    <head>
        ...
        <meta http-equiv="refresh" content="4;url=http://localhost:8081/SistemaAgil_IS2/DesarrolloController?accion=Redirect AM de Sprints">
    ...
    <body>
        <h1>Sprint creado exitosamente!</h1>
