    ...
    <body>
        ...
        <div class="buttons">
            <form action="DesarrolloController" method="POST" style="margin:0; padding:0">
                ...
                <input class="btn yellow" type="submit" name="accion" value="Asignar Proyecto a Backlog"/>
                <input class="btn yellow" type="submit" name="accion" value="Agregar US a Backlogs"/>
            </form>
        </div>